...
DATA_SOURCES = {
    "期货": ["东方财富", "同花顺", "金十数据"],
    "A 股": ["财联社", "东方财富", "同花顺", "金十数据"]
}

# ==================== 模拟新闻数据 ====================
def get_future_news():
    """获取期货新闻（精简：只保留重大消息，多数据源）"""
    return [
        {
            "time": "03-20 16:48",
            "title": "商品期货指数下跌 2.93%",
...
def get_stock_news():
    """获取 A 股板块新闻（精简：只保留催化剂，多数据源）"""
    return {
        "算力": [
            {"time": "3/22", "title": "AI 算力需求持续爆发", "impact": "✅ 利好", "source": "同花顺"}
        ],
        "电力": [
            {"time": "3/25-27", "title": "清洁能源博览会 (北京)", "impact": "✅ 催化", "source": "财联社"},
            {"time": "3/21", "title": "电力体制改革持续推进", "impact": "✅ 利好", "source": "金十数据"}
        ],
        "储能电池": [
            {"time": "3/23-26", "title": "国际储能大会", "impact": "✅ 重点", "source": "同花顺"},
            {"time": "3/25-27", "title": "钙钛矿论坛 (无锡)", "impact": "✅ 技术", "source": "金十数据"}
        ],
        "机器人": [
            {"time": "4/17-19", "title": "人形机器人大会 (上海)", "impact": "✅ 中期", "source": "财联社"},
            {"time": "3/20", "title": "机器人产业政策有望出台", "impact": "✅ 利好", "source": "同花顺"}
        ],
        "商业航天": [
            {"time": "3/21", "title": "商业航天列入重点发展方向", "impact": "✅ 利好", "source": "金十数据"}
        ]
    }
